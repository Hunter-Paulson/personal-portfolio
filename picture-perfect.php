...
<html lang="en">
    ...
    <body class="movie-page">
        ...
        <main class="single-work-page">
            ...
            <div class="image">
                <img src="images/picturePerfectDesktopMockup.png" alt="A responsive mockup of DiscoveryFlix on mobile, and desktop screen sizes."/>
            </div>
                    ...
                    <div id="home" class="tab-pane fade in active">
                        <div class="content-container">   
                            <div>
                                ...
                                <p>Mode Screen: Allow users to choose how many players there are, and an input to enter their names. Choose a game mode difficulty. As well as buttons to ask for help, quit, or click play to enter the game screen.</p>
